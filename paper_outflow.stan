// ============================================================================
// Azose & Raftery (2019) — OUTFLOW MODEL (Emigration Rate)
//
// Paper equations:
...
//   σ_i ~ Beta(a₀, b₀)
//
// We model log(δ_it) directly. δ = E_it / P_it is the emigration rate.
// ============================================================================
...
parameters {
  ...
  real<lower=0> tau_0;                     // SD of μ_i across origins
...
model {
  ...
  tau_0 ~ normal(0, 5);                   // weakly informative on τ₀
  mu ~ normal(nu, tau_0);                 // μ_i ~ Normal(ν, τ₀²)
